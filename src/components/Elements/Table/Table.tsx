                ...
                {data.map((entry, entryIndex) => (
                  ...
                  >
                    {columns.map(({ Cell, field, title }, columnIndex) => (
                      ...
                      >
                        {/* TODO: Not completely sure if we'll always want to get the fields value as a string but this gets rid of the type error and we are not currently using this component anyways. */}
